...
@Getter
@Setter
public class TbInformacaoEspecificaObjetoSeguradoPatrimonial {
    ...
    @Column(length = 7)
    private String dsIndicadorCoberturaBasica;
    ...
    private Set<TbObjetoSeguradoEspecificoPatrimonial> apoliceTbObjetoSeguradoEspecificoPatrimonials;
